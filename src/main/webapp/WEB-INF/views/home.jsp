    ...
    <div class="content">
        ...
        <div class="main-banner">
		    <div class="slider-container">
		        <div class="slide">
		            <img src="/images/모수 긴 화면 2.png" alt="슬라이드 1 이미지" class="slide-image">
		        </div>
		        <div class="slide">
		            <img src="/images/티앤미미.jpg" alt="슬라이드 2 이미지" class="slide-image">
		        </div>
		        <div class="slide">
		            <img src="/images/에드워드리.jpg" alt="슬라이드 3 이미지" class="slide-image">
		        </div>
		        <div class="slide">
		            <img src="/images/물고기.jpg" alt="슬라이드 4 이미지" class="slide-image">
		        </div>
		    </div>
